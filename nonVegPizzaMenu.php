...
<head>
    ...
    <script src="validate/nonvegevalidate.js"></script>
...
<body>
    ...
    <div class="container">
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">NON VEG-PIZZA</li>
            </ol>
        </nav>
    </div>
    <h4 class="text-center">Pizza-Paradise NON-VEG PIZZA</h4>
    <br>
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4 text-center">
            ...
            <?php
            $query = "select * from non_veg_pizza order by non_veg_pizza_ID asc";
            ...
            ?>
                    ...
                    <div class="col">
                        <div class="card shadow p-3 mb-5 bg-body rounded">
                            <form method="post" action="addToCart.php?action=addn&non_veg_pizza_ID=<?php echo $row["non_veg_pizza_ID"]; ?>" onsubmit="return validateForm()">
                                <input type="hidden" name="hidden_id" value="<?php echo $row["non_veg_pizza_ID"]; ?>">
